...
"$NDK_PATH"/25.2.9519653/ndk-build APP_PLATFORM=android-21 NDK_DEBUG=0 NDK_OUT="$GDE_ANDROID_PATH"/sdl/build/intermediates/ndkBuild/"$BUILD_TYPE"/object NDK_LIBS_OUT="$GDE_ANDROID_PATH"/sdl/build/intermediates/ndkBuild/"$BUILD_TYPE"/lib